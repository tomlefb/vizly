...
function portfolioToFormData(p: Portfolio): PortfolioFormData {
  return {
    ...
    body_color: p.body_color ?? p.secondary_color,
    ...
    contact_form_enabled: p.contact_form_enabled ?? false,
    contact_form_title: p.contact_form_title ?? 'Me contacter',
    contact_form_description: p.contact_form_description ?? 'Intéressé par mon profil ? N\'hésite pas à m\'écrire.',
...
const DEFAULT_PORTFOLIO: PortfolioFormData = {
  ...
  contact_form_description: 'Intéressé par mon profil ? N\'hésite pas à m\'écrire.',
  skills: [],
  sections: undefined,
  custom_blocks: [],
  kpis: [],
