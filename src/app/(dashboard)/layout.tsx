...
// Dashboard privé : redirect forcé si non authentifié, mais on noindex en
// plus au cas où Google suivrait un lien externe pour éviter toute fuite
// dans l'index (cas : liens partagés, referrers, etc.).
