...
export const TEMPLATE_CONFIGS: TemplateConfig[] = [
  ...
  },
  {
    ...
    idealFor: 'un premier portfolio, un CV en ligne, une candidature',
  },
  {
    name: 'colore',
    label: 'Coloré',
    description: 'Couleurs vives et layout dynamique. Pour ceux qui assument d\'être visibles.',
    isPremium: false,
  ...
  },
  {
    ...
    idealFor: 'ceux qui veulent laisser respirer leurs visuels',
  },
  {
    name: 'bento',
    label: 'Bento',
    description: 'Layout en grid bento, sections modulables en cartes',
    isPremium: true,
