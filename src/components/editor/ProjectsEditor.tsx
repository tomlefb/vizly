  ...
  return (
    <div className="flex-1 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button type="button" onClick={openAddProject} className="inline-flex items-center gap-1.5 text-sm font-medium text-accent hover:text-accent-hover transition-colors">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative w-full max-w-[560px] max-h-[85vh] flex flex-col bg-white rounded-xl overflow-hidden mx-4">
            ...
            <div className="shrink-0 px-8 py-4 bg-white border-t border-[#E5E7EB] flex items-center justify-end gap-3">
              ...
              <button type="button" onClick={saveProject} disabled={!editingProject.title.trim()} className={cn('h-10 rounded-lg px-5 text-sm font-medium transition-colors duration-150', !editingProject.title.trim() ? 'bg-accent/50 text-white/60 cursor-not-allowed' : 'bg-accent text-white hover:bg-accent-hover')}>
