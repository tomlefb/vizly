  ...
  return (
    <>
      ...
      >
        ...
        <header className="px-5 pt-12 pb-10 md:px-12 md:pt-20 md:pb-16 lg:px-20">
          <div className="mx-auto max-w-6xl">
            <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-12 md:gap-6">
              ...
              <div className="md:col-span-7 lg:col-span-8">
                ...
                {/* Social links -- discrete, horizontal */}
        ...
        <main className="px-5 py-14 md:px-12 md:py-20 lg:px-20">
          <div className="mx-auto max-w-6xl">
            <h2
              style={{
                fontFamily: "'Syne', sans-serif",
